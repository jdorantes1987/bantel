...
class Estudiante(p.Persona):
    def __init__(self, cedula, nombre, apellido, edad, telefono, direccion, materias, estatus):
        super().__init__(cedula, nombre, apellido, edad, telefono, direccion)
        self.materias = materias
        self.estatus = estatus


estudiante1 = Estudiante('15152791', 'Mirtha', 'Graterol', 42, '04146126353', 'Catia', 'Seguros', 'A')
