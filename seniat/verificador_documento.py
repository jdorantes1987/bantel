...
class VerificadorDocumento:
    ...
    def __es_documento_valido(self):
        ...
        es_valido_sin_letras = (
            len(self.__extraer_numeros(self.documento)) > 4
            and len(self.__extraer_numeros(self.documento)) <= 8
            and not tiene_letra
        )
        return (
            not tiene_mas_de_una_letra and es_dimension_valida
        ) or es_valido_sin_letras
