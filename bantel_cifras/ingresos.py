...
from articulos import get_data_art_con_sus_sub_cod
from articulos import get_maestro_linea_art
from articulos import agrupa_facturacion
...
def get_data_facturacion_con_linea_art(**kwargs):
    ...
    linea_art = get_maestro_linea_art()[['co_lin', 'grupo', 'lin_des', 'detalle']]
        ...
        # hoja 'Cod_Articulos'
    join = pd_merge(facturas, articulos, how='left', left_on='cod_art_izq', right_on='co_art')
    ...
    merge = pd_merge(linea_art, group_art_x_fact, how='left', left_on='co_lin', right_on='campo1')
