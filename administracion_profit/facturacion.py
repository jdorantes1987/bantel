...
from facturas import procesar_facturacion_masiva
...
def procesar_documentos(indice_file, a_bs, num_fact_format):
    ...
    """
    if indice_file == 0:
        dict_con_admin.update({"host":"10.100.104.11", "base_de_datos": "BANTEL_I", })
    else:
        dict_con_admin.update({"host":"10.100.104.11", "base_de_datos": "BANTEL_A", })  # 10.100.104.11 BANTEL PRODUCCIÓN | 10.22.22.3 BANTEL DESARROLLO
