...
# print('El valor de la tasa para la fecha indicada es de:', get_tasa_fecha('20230602')) # Obtiene valor la TASA según la FECHA indicada
# print('\ncantidad de $ {:,.2f}'.format(a_divisas_segun_fecha(12520.62, '20240424')))  # Obtiene MONTO OPERACIÓN en usd según la tasa de la FECHA indicada
# print('Equivalente en $ {:,.2f}'.format(a_divisas(1629.20)))  # Convertir a Dólares
# print('Equivalente en Bs. {:,.2f}'.format(a_bolivares(100)))  # Convertir a Bolívares

# -->ESTADO DE CUENTA
# registrar_mov_ban_edo_cta()  # Registrar los movimientos bancarios seleccionados del estado de cuenta actual banesco
...
# print(buscar_en_client(patron, resumir_datos=True).reset_index(drop=True).to_string())  # Muestra los resultados de la busqueda en la tabla de CLIENTES
...
# print(new_cod_client()) # Obtiene nuevo código de cliente del módulo de la izquierda
