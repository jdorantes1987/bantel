...
class datos_profit:
    ...
    def __init__(self, host, data_base_admin, data_base_cont):
        ...
        self.dict_con_admin = {'host': host, 'base_de_datos': data_base_admin}  # BANTEL_A, BANTEL_I
        self.dict_con_contab = {'host': host, "base_de_datos": data_base_cont}  # TBANTEL_C, BANTEL_IC      
    ...
    def clientes(self):
        sql = """
            SELECT RTRIM(co_cli) as co_cli, RTRIM(cli_des) as cli_des, direc1, direc2, dir_ent2, telefonos, fax, respons, fecha_reg, 
                    ...
                    co_us_mo, fe_us_mo, campo3, RTRIM(matriz) as matriz 
            FROM saCliente 
            """
        return get_read_sql(sql, **self.dict_con_admin)
