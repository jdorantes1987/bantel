...
p_data_edo_cta_banesco = 'C:/Users/jdorantes/Documents/Analisis/Estados de Cuenta/Banesco/2024/08. AGO/Banesco Agosto 2024.xlsx'
...
def datos_estadisticas_tasas():
    ...
    hist_tc = hist_tc.drop(hist_tc.columns[0], axis=1).reset_index(drop=True)  # Elimina la primera columna del dataframe
    return hist_tc
