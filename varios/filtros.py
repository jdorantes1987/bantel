...
df1 = pd.DataFrame({'Name': ['Geeks', 'Peter', 'James', 'Jack', 'Lisa'],
...
df2 = pd.DataFrame({'Name': ['Geeks', 'Peter', 'James', 'Jack', 'Lisa'],
                   'Team': ['Boston', 'Boston', 'Boston', 'Chele', 'Barse'],
                   'Position': ['PG', 'PG', 'UG', 'PG', 'UG'],
                   'Number': [3, 4, 7, 11, 5],
                   'Age': [33, 25, 34, 35, 28],
...
print('\n' * 2, "filtre todas las filas en las que Equipo contenga 'Boston' o Universidad contenga 'MIT'")
df4 = pd.DataFrame({'Name': ['Geeks', 'Peter', 'James', 'Jack', 'Lisa'],
                   'Team': ['Boston', 'Boston', 'Boston', 'Chele', 'Barse'],
                    'Position': ['PG', 'PG', 'UG', 'PG', 'UG'],
                    'Number': [3, 4, 7, 11, 5],
                    'Age': [33, 25, 34, 35, 28],
...
print('\n' * 2, "las filas de filtro que verifican el nombre del equipo contienen 'Boston' y la posición debe ser P'G'")
...
print('\n' * 2, "las filas de filtro que verifican que la posición contiene PG y la universidad debe contener como UC.")
# haciendo marco de datos
