import datetime
import pandas as pd
cadena = 'El resultado de sumar {id_Mov} y {descr} es'.format(id_Mov='MB20231214', descr='Prueba')
...
lst = [['Geeks', 'For', 'Geeks', 'is',
        'portal', 'for', 'Geeks', 'l'], ['Jackson', 'Jhoan', 'Mirtha', 'Alejandro', 'Samira', 'Mafer']]
lst2 = ['Wilmer', 'Luis']
