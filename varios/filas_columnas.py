...
print('\n' * 2, 'Imprime la cantidad de valores no nulos, esto aplica tambien para los valores no nulos')
nulos_x_columnas = pagos.notnull().sum()
print(nulos_x_columnas)

print('\n' * 2, 'Separa los String de la columna en caracteres individuales, si se desea separar por palabras debe colocar un espacio como caracter separador')
