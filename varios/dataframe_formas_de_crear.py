...
df4 = pd.DataFrame(data4, index=['rank1',
                               'rank2',
                               'rank3',
                               'rank4'])
...
print('\n' * 2, 'Crea DataFrame a partir de listas de diccionarios tanto con índice de fila como con índice de columna.')
data7 = [{'a': 1, 'b': 2},
         {'a': 5, 'b': 10, 'c': 20}]

# Con índices de dos columnas, valores iguales
# como teclas de diccionario
df7 = pd.DataFrame(data7, index=['first',
                                'second'],
                   columns=['a', 'b'])

# Con índices de dos columnas con
# un índice con otro nombre
df8 = pd.DataFrame(data7, index=['first',
                                'second'],
                   columns=['a', 'b1'])
...
df9 = pd.DataFrame(list_of_tuples,
                   columns=['Name', 'Age'])
...
d2 = {'one': pd.Series([10, 20, 30, 40],
                      index=['a', 'b', 'c', 'd']),
     'two': pd.Series([100, 200, 300, 400],
                      index=['a', 'b', 'c', 'd'])}
...
a_dict = {'Nombres': ['Jackson', 'Mirtha', 'Samira', 'Mafer'],
