...
# Lee un archivo .csv
docCompras = pd.read_csv(
    "saDocumentoCompra.csv", delimiter=";", encoding="ISO-8859-1", on_bad_lines="skip"
)
...
docCompras["mes_l"] = docCompras["fec_reg"].dt.month_name(
    locale="es_ES.utf8"
)  # CONVIERTE EL MES DE LA FECHA A LETRAS
