...
if numero >= 0 and numero <= 9.4:
    ...
    print(msgIni, "ha pasado con una calificación DEFICIENTE de", numero, "Puntos", sep=" ")
elif numero >= 14.5 and numero <= 15.4:
    print(msgIni, "ha pasado con una calificación REGULAR de", numero, "Puntos", sep=" ")
elif numero >= 15.5 and numero <= 16.4:
    print(msgIni, "ha pasado con una calificación EFICIENTE de", numero, "Puntos", sep=" ")
elif numero >= 16.5 and numero <= 19.4:
    print(msgIni, "ha pasado con una calificación EXCELENTE de", numero, "Puntos", sep=" ")
elif numero > 19:
    print(msgIni, "ha pasado con una calificación SOBRESALIENTE de", numero, "Puntos", sep=" ")
else:
    print("La ncalificación ingresada no está dentro del rango permitido.", "Puntos", sep=" ")
